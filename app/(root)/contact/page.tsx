...
const Contact = () => {
    return (
        <div className='flex xl:h-[calc(100vh-8.5rem)] w-full xl:px-24 flex-wrap xl:flex-nowrap'>
            <div className="xl:w-1/2 w-full p-4 xl:p-10">
                <ContactForm />
            </div>
            <div className="hidden xl:flex xl:w-1/2 w-full xl:p-10 h-fit flex-wrap justify-center text-5xl xl:text-9xl mt-20 xl:mt-0">
